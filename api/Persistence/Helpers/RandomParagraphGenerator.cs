...
namespace Persistence.Helpers {
	public class RandomParagraphGenerator {
		...
		/// <summary>
		/// Generates a set number of paragraphs that will contain random words.
		/// </summary>
		...
		public static string AddContentParagraphs(int numberParagraphs, int minSentences,
		...
		private static void AddParagraph(int numberSentences, int minWords, int maxWords) {
		...
		private static void AddSentence(int numberWords) {
