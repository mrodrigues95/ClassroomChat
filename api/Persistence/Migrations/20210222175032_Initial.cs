        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    discussions_count = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_photos_application_user_application_user_id",
            ...
            migrationBuilder.CreateTable(
                name: "application_user_classrooms",
                columns: table => new
                {
                    application_user_id = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_application_user_classrooms", x => new { x.application_user_id, x.classroom_id });
                    table.ForeignKey(
                        name: "fk_application_user_classrooms_application_user_application_us",
                        column: x => x.application_user_id,
                        principalTable: "AspNetUsers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_application_user_classrooms_classrooms_classroom_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_discussions_application_user_created_by_id",
                        column: x => x.created_by_id,
                        principalTable: "AspNetUsers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    created_at = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    expire_after_first_use = table.Column<bool>(type: "boolean", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_invite_links_application_user_created_by_id",
                        column: x => x.created_by_id,
                        principalTable: "AspNetUsers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_invite_links_classrooms_classroom_id",
                        column: x => x.classroom_id,
                        principalTable: "classrooms",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_messages_application_user_created_by_id",
                        column: x => x.created_by_id,
                        principalTable: "AspNetUsers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "ix_application_user_classrooms_classroom_id",
                table: "application_user_classrooms",
                column: "classroom_id");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_discussions_created_by_id",
                table: "discussions",
                column: "created_by_id");

            migrationBuilder.CreateIndex(
                name: "ix_invite_links_classroom_id",
                table: "invite_links",
                column: "classroom_id");

            migrationBuilder.CreateIndex(
                name: "ix_invite_links_created_by_id",
                table: "invite_links",
                column: "created_by_id");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_photos_application_user_id",
                table: "photos",
